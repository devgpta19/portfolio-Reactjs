                    ...
                    <div className='h-full w-full flex lg:flex-row items-center justify-center mt-20 flex-col-reverse lg:px-10 lg:gap-8'>
                        ...
                        <div className='flex items-center justify-center p-10'>
                            <div className='w-[70%] max-sm:w-[80%] flex justify-center items-center flex-col'>
                                <h1 className='text-center bg-transparent text-orange-50 lg:text-3xl text-[2rem]' ><span className='text-orange-400'>Imagine </span> the world where every interaction is seamless, <span className='text-orange-400'>every design </span> captivates the eye, <span className='text-orange-400'>every application </span> shares a story, <span className='text-orange-400'>every user </span> feels truly valued, and everything is wonderfully easy to use.</h1> <br />
