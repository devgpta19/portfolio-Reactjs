...
const Home = () => {
  ...
  return (
    <>
      <div ref={ref} className=' py-5 px-10 min-h-screen min-w-screen md:gap-8 md:px-3 justify-center max-sm:pt-20 items-center lg:justify-between flex flex-col lg:flex-row lg:items-center'>
        <div>
